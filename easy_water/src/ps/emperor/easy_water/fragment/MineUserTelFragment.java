...
import ps.emperor.easy_water.utils.CommonUtil;
...
public class MineUserTelFragment extends Fragment implements OnClickListener {
	...
	private TextView verification_code, btn_control_true,
			text_mine_user_info_tel;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		btn_control_true = (TextView) view
				.findViewById(R.id.btn_apply_irrigate_unit_control_true);
		btn_control_true.setOnClickListener(this);
		edit_mine_user_info_tel = (EditText) view
				.findViewById(R.id.edit_mine_user_info_tel);
		edit_mine_user_info_tel.setInputType(EditorInfo.TYPE_CLASS_PHONE);
		text_mine_user_info_tel = (TextView) view
				.findViewById(R.id.text_mine_user_info_tel);
		verification_codes = (EditText) view
				.findViewById(R.id.verification_codes);
		verification_codes.setInputType(EditorInfo.TYPE_CLASS_PHONE);
		text_mine_user_info_tel = (TextView) view
				.findViewById(R.id.text_mine_user_info_tel);
	...
	public void onClick(View v) {
		...
		case R.id.acitionbar_left:
			((InputMethodManager) edit_mine_user_info_tel.getContext()
					.getSystemService(getActivity().INPUT_METHOD_SERVICE))
					.hideSoftInputFromWindow(
							edit_mine_user_info_tel.getWindowToken(),
							InputMethodManager.HIDE_NOT_ALWAYS);
			((InputMethodManager) verification_codes.getContext()
					.getSystemService(getActivity().INPUT_METHOD_SERVICE))
					.hideSoftInputFromWindow(
							verification_codes.getWindowToken(),
							InputMethodManager.HIDE_NOT_ALWAYS);
		...
		case R.id.btn_apply_irrigate_unit_control_true:
			if (CheckUtil.IsEmpty(edit_mine_user_info_tel.getText().toString())) {
				Toast.makeText(getActivity(), "请输入新手机号码！", Toast.LENGTH_SHORT)
						.show();
			} else if (CheckUtil.IsEmpty(verification_codes.getText()
					.toString())) {
				...
				if (!NetStatusUtil.isNetValid(getActivity())) {
					...
					try {
						...
						js_request.put("phoneNum", edit_mine_user_info_tel
								.getText().toString());
						js_request.put("verificationCode", verification_codes
								.getText().toString());
	...
	public void backTimer() {
		verification_code.setText(recLen + "");

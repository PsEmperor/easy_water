...
@SuppressLint("NewApi")
public class MainTainIrrigateFragment extends Fragment implements
	...
	public void onItemClick(AdapterView<?> parent, View view,
		...
		// MainTainIrrigateInfoFragment fragment = new
		// MainTainIrrigateInfoFragment();
		...
		// transaction.commit();
		// 数据库存储
		SharedUtils.setParam(getActivity(), "units", beens.get(position)
				.getIrriUnitName());
		SharedUtils.setParam(getActivity(), "FirstDerviceID",
				beens.get(position).getFirstDerviceID());

		Intent intent = new Intent(getActivity(),
				MainTainPresentrrigateActivity.class);
					...
					x.http().request(HttpMethod.GET, param3,
							new CommonCallback<String>() {
								...
								public void onSuccess(String arg0) {
									...
									Gson gson = new Gson();
									System.out.println(arg0);
									UserReleIrrInfoBean fromJson = gson
											.fromJson(arg0,
													UserReleIrrInfoBean.class);

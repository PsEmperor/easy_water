...
public class ApplyWaterDistrbutionGate extends Fragment implements
	...
	private TextView tv_indicator, tv_superior, tv_time_operation_start,
			tv_time_operation_end;
	...
	private RelativeLayout layout, layout_relative_changes,
			layout_relative_changes_left, layout_relative_changes_right;
	...
	private RelativeLayout layout_relative_changes_one,
			layout_relative_changes_two, layout_relative_changes_three;
	private RelativeLayout layout_relative_change, layout_relative_change_left,
			layout_relative_change_right, layout_relative_changes_ones,
			layout_relative_changes_twos, layout_relative_changes_threes,
			layout_show_left_and_right;
	...
	private TextView tv_one_OpenHigh, tv_one_OpenProportion, tv_one_PoreID,
			tv_two_OpenProportion_left, tv_two_OpenHigh_left,
			tv_two_PoreID_left, tv_two_OpenProportion_right,
			tv_two_OpenHigh_right, tv_two_PoreID_right,
			tv_three_OpenProportion_left, tv_three_OpenHigh_left,
			tv_three_PoreID_left, tv_three_OpenProportion, tv_three_OpenHigh,
			tv_three_PoreID, tv_three_OpenProportion_right,
			tv_three_OpenHigh_right, tv_three_PoreID_right;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		tv_time_operation = (RelativeLayout) view
				.findViewById(R.id.tv_time_operation);
		tv_time_operation.setOnClickListener(this);

		btn_time_operation = (Button) view
				.findViewById(R.id.btn_time_operation);
		btn_time_operation.setOnClickListener(this);

		adapter = new ApplyWaterDistrbutionGateAdapter(getActivity());

		list_apply_water_distrbution_gate_control = (HorizontalListView) view
				.findViewById(R.id.list_apply_water_distrbution_gate_control);
		layout = (RelativeLayout) view
				.findViewById(R.id.layout_relative_change);
		layout_linear_change = (LinearLayout) view
				.findViewById(R.id.layout_linear_change);
		text_apply_water_distrbution_gate_control = (TextView) view
				.findViewById(R.id.text_apply_water_distrbution_gate_control);

		layout_relative_changes = (RelativeLayout) view
				.findViewById(R.id.layout_relative_changess);
		layout_relative_changes_left = (RelativeLayout) view
				.findViewById(R.id.layout_relative_changes_lefts);
		layout_relative_changes_right = (RelativeLayout) view
				.findViewById(R.id.layout_relative_changes_rights);

		layout_relative_changes_one = (RelativeLayout) view
				.findViewById(R.id.layout_relative_changes_ones);
		layout_relative_changes_two = (RelativeLayout) view
				.findViewById(R.id.layout_relative_changes_twos);
		layout_relative_changes_three = (RelativeLayout) view
				.findViewById(R.id.layout_relative_changes_threes);
		layout_linear_changes = (LinearLayout) view
				.findViewById(R.id.layout_linear_changes);
		tv_time_operation_start = (TextView) view
				.findViewById(R.id.tv_time_operation_start);
		tv_time_operation_end = (TextView) view
				.findViewById(R.id.tv_time_operation_end);

		tv_superior = (TextView) view
				.findViewById(R.id.tv_apply_water_distrbution_gate_control_superior);

		layout_relative_change = (RelativeLayout) view
				.findViewById(R.id.layout_relative_changes);
		layout_relative_change_left = (RelativeLayout) view
				.findViewById(R.id.layout_relative_changes_left);
		layout_relative_change_right = (RelativeLayout) view
				.findViewById(R.id.layout_relative_changes_right);
		layout_relative_changes_ones = (RelativeLayout) view
				.findViewById(R.id.layout_relative_changes_one);
		layout_relative_changes_twos = (RelativeLayout) view
				.findViewById(R.id.layout_relative_changes_two);
		layout_relative_changes_threes = (RelativeLayout) view
				.findViewById(R.id.layout_relative_changes_three);

		tv_one_OpenProportion = (TextView) view
				.findViewById(R.id.tv_one_OpenProportion);
		...
		tv_two_OpenProportion_left = (TextView) view
				.findViewById(R.id.tv_two_OpenProportion_left);
		tv_two_OpenHigh_left = (TextView) view
				.findViewById(R.id.tv_two_OpenHigh_left);
		tv_two_PoreID_left = (TextView) view
				.findViewById(R.id.tv_two_PoreID_left);
		tv_two_OpenProportion_right = (TextView) view
				.findViewById(R.id.tv_two_OpenProportion_right);
		tv_two_OpenHigh_right = (TextView) view
				.findViewById(R.id.tv_two_OpenHigh_right);
		tv_two_PoreID_right = (TextView) view
				.findViewById(R.id.tv_two_PoreID_right);
		tv_three_OpenProportion_left = (TextView) view
				.findViewById(R.id.tv_three_OpenProportion_left);
		tv_three_OpenHigh_left = (TextView) view
				.findViewById(R.id.tv_three_OpenHigh_left);
		tv_three_PoreID_left = (TextView) view
				.findViewById(R.id.tv_three_PoreID_left);
		tv_three_OpenProportion = (TextView) view
				.findViewById(R.id.tv_three_OpenProportion);
		tv_three_OpenHigh = (TextView) view
				.findViewById(R.id.tv_three_OpenHigh);
		tv_three_PoreID = (TextView) view.findViewById(R.id.tv_three_PoreID);
		tv_three_OpenProportion_right = (TextView) view
				.findViewById(R.id.tv_three_OpenProportion_right);
		tv_three_OpenHigh_right = (TextView) view
				.findViewById(R.id.tv_three_OpenHigh_right);
		tv_three_PoreID_right = (TextView) view
				.findViewById(R.id.tv_three_PoreID_right);
		tv_apply_water_before = (TextView) view
				.findViewById(R.id.tv_apply_water_before);
		tv_apply_water_after = (TextView) view
				.findViewById(R.id.tv_apply_water_after);
		tv_apply_water_flow = (TextView) view
				.findViewById(R.id.tv_apply_water_flow);
		layout_show_left_and_right = (RelativeLayout) view
				.findViewById(R.id.layout_show_left_and_right);
		...
		list_apply_water_distrbution_gate_control
				.setOnScrollStateChangedListener(new OnScrollStateChangedListener() {
					...
					public void onScrollStateChanged(ScrollState scrollState) {
						...
						case SCROLL_STATE_IDLE:// 是当屏幕停止滚动时
							// 判断滚动到底部
							if (list_apply_water_distrbution_gate_control
									.getLastVisiblePosition() == (list_apply_water_distrbution_gate_control
									.getCount())) {
						...
						case SCROLL_STATE_TOUCH_SCROLL:// 滚动时
							if (list_apply_water_distrbution_gate_control
									.getFirstVisiblePosition() > lastVisibleItemPosition) {// 上滑
								imageLeft.setVisibility(View.VISIBLE);
								imageRight.setVisibility(View.GONE);

							} else if (list_apply_water_distrbution_gate_control
									.getFirstVisiblePosition() < lastVisibleItemPosition) {// 下滑
								imageLeft.setVisibility(View.VISIBLE);
								imageRight.setVisibility(View.VISIBLE);
							} else {
								return;
							}
							lastVisibleItemPosition = list_apply_water_distrbution_gate_control
	...
	// if (scrollFlag
	// &&
	// ScreenUtils.getScreenViewBottomHeight(list_apply_water_distrbution_gate_control)
	// >= ScreenUtils
	...
	private void init() {
		...
		x.http().request(HttpMethod.GET, param3, new CommonCallback<String>() {
			...
			public void onSuccess(String arg0) {
				...
				FindDisWaterInfoOneBean fromJson = gson.fromJson(arg0,
						FindDisWaterInfoOneBean.class);
				...
				if (!CheckUtil.IsEmpty(beans)) {
					...
					if (beans.size() == 1) {
						...
						RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) layout_relative_changes
								.getLayoutParams();
						int height;
						if (CheckUtil.IsEmpty(beans.get(0).getOpenProportion())) {
							height = DensityUtil.dip2px(getActivity(),
									(int) ((100 - Float.valueOf(0) * 100) * 2));
						} else {
							height = DensityUtil.dip2px(getActivity(),
									(int) ((100 - Float.valueOf(beans.get(0)
											.getOpenProportion()) * 100) * 2));
						}
						...
						if (CheckUtil.IsEmpty(beans.get(0).getOpenProportion())) {
							...
							tv_one_OpenProportion.setText((int) (Float
									.valueOf(beans.get(0).getOpenProportion()) * 100)
									+ "%");
						}
						if (CheckUtil.IsEmpty(beans.get(0).getOpenHigh())) {
							tv_one_OpenHigh.setText(0 + "m³");
						} else {
							tv_one_OpenHigh.setText(beans.get(0).getOpenHigh()
									+ "m³");
						}
						...
						list_apply_water_distrbution_gate_control
								.setVisibility(View.GONE);
						RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) layout_relative_changes_left
								.getLayoutParams();
						int height;
						if (CheckUtil.IsEmpty(beans.get(0).getOpenProportion())) {
							height = DensityUtil.dip2px(getActivity(),
						...
						if (CheckUtil.IsEmpty(beans.get(0).getOpenHigh())) {
							...
							tv_two_OpenHigh_left.setText(beans.get(0)
									.getOpenHigh() + "m³");
						}

						tv_two_PoreID_left.setText(beans.get(0).getPoreID());

						RelativeLayout.LayoutParams layoutParam1 = (RelativeLayout.LayoutParams) layout_relative_changes_right
								.getLayoutParams();
						int heights;
						if (CheckUtil.IsEmpty(beans.get(1).getOpenProportion())) {
							heights = DensityUtil.dip2px(getActivity(),
									(int) ((100 - Float.valueOf(0) * 100) * 2));
						} else {
							heights = DensityUtil.dip2px(getActivity(),
									(int) ((100 - Float.valueOf(beans.get(1)
											.getOpenProportion()) * 100) * 2));
						}
						layoutParam1.height = heights;
						layout_relative_changes_right
								.setLayoutParams(layoutParam1);
						layout_relative_changes_right.requestLayout();
						if (CheckUtil.IsEmpty(beans.get(1).getOpenProportion())) {
							tv_two_OpenProportion_right.setText(0 + "%");
						} else {
							tv_two_OpenProportion_right.setText((int) (Float
									.valueOf(beans.get(1).getOpenProportion()) * 100)
									+ "%");
						}
						if (CheckUtil.IsEmpty(beans.get(1).getOpenHigh())) {
							tv_two_OpenHigh_right.setText(0 + "m³");
						} else {
							tv_two_OpenHigh_right.setText(beans.get(1)
									.getOpenHigh() + "m³");
						}
						...
						list_apply_water_distrbution_gate_control
								.setVisibility(View.GONE);
						RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) layout_relative_changes_one
								.getLayoutParams();
						int height;
						if (CheckUtil.IsEmpty(beans.get(0).getOpenProportion())) {
							height = DensityUtil.dip2px(getActivity(),
						...
						if (CheckUtil.IsEmpty(beans.get(0).getOpenHigh())) {
							...
							tv_three_OpenHigh_left.setText(beans.get(0)
									.getOpenHigh() + "m³");
						}
						tv_three_PoreID_left.setText(beans.get(0).getPoreID());

						RelativeLayout.LayoutParams layoutParam1 = (RelativeLayout.LayoutParams) layout_relative_changes_two
								.getLayoutParams();
						int heights;
						if (CheckUtil.IsEmpty(beans.get(1).getOpenProportion())) {
							heights = DensityUtil.dip2px(getActivity(),
						...
						if (CheckUtil.IsEmpty(beans.get(1).getOpenHigh())) {
							...
							tv_three_OpenHigh.setText(beans.get(1)
									.getOpenHigh() + "m³");
						}
						tv_three_PoreID.setText(beans.get(1).getPoreID());

						RelativeLayout.LayoutParams layoutParam2 = (RelativeLayout.LayoutParams) layout_relative_changes_three
								.getLayoutParams();
						int height2;
						if (CheckUtil.IsEmpty(beans.get(2).getOpenProportion())) {
							height2 = DensityUtil.dip2px(getActivity(),
									(int) ((100 - Float.valueOf(0) * 100) * 2));
						} else {
							height2 = DensityUtil.dip2px(getActivity(),
									(int) ((100 - Float.valueOf(beans.get(2)
											.getOpenProportion()) * 100) * 2));
						}
						layoutParam2.height = height2;
						layout_relative_changes_three
								.setLayoutParams(layoutParam2);
						layout_relative_changes_three.requestLayout();
						if (CheckUtil.IsEmpty(beans.get(2).getOpenProportion())) {
							tv_three_OpenProportion_right.setText(0 + "%");
						} else {
							tv_three_OpenProportion_right.setText((int) (Float
									.valueOf(beans.get(2).getOpenProportion()) * 100)
									+ "%");
						}
						if (CheckUtil.IsEmpty(beans.get(2).getOpenHigh())) {
							tv_three_OpenHigh_right.setText(0 + "m³");
						} else {
							tv_three_OpenHigh_right.setText(beans.get(2)
									.getOpenHigh() + "m³");
						}
				...
				if (!CheckUtil.IsEmpty(beens)) {
					if (CheckUtil.IsEmpty(beens.get(0).getDisEquName())) {
						...
						text_apply_water_distrbution_gate_control.setText(beens
								.get(0).getDisEquName());
					}
	...
	public void onClick(View v) {
		...
		case R.id.tv_indicator:
			...
			if (CheckUtil.IsEmpty(beans)) {
				...
				if (CheckUtil.IsEmpty(beans.get(0).getOpenProportion())) {
					...
					bundle2.putInt("OpenProportion", (int) (Float.valueOf(beans
							.get(0).getOpenProportion()) * 100));
				}
				if (CheckUtil.IsEmpty(beans.get(0).getOpenHigh())) {
		...
		case R.id.btn_time_operation:
			...
			if (CheckUtil.IsEmpty(beens.get(0).getClosePoreTime())) {
				...
				bundle.putString("ClosePoreTime", beens.get(0)
						.getClosePoreTime());
			}
			if(CheckUtil.IsEmpty(planStat)){
				bundle.putString("planStat", "0");
			}else{
				bundle.putString("planStat", "1");
			}
		...
		case R.id.layout_relative_changes:
			...
			if (CheckUtil.IsEmpty(beans)) {
				...
				if (CheckUtil.IsEmpty(beans.get(0).getOpenProportion())) {
					...
					bundle3.putInt("OpenProportion", (int) (Float.valueOf(beans
							.get(0).getOpenProportion()) * 100));
				}
				if (CheckUtil.IsEmpty(beans.get(0).getOpenHigh())) {
		...
		case R.id.layout_relative_changes_left:
			...
			if (CheckUtil.IsEmpty(beans)) {
				...
				if (CheckUtil.IsEmpty(beans.get(0).getOpenProportion())) {
					...
					bundle4.putInt("OpenProportion", (int) (Float.valueOf(beans
							.get(0).getOpenProportion()) * 100));
				}
				if (CheckUtil.IsEmpty(beans.get(0).getOpenHigh())) {
		...
		case R.id.layout_relative_changes_right:
			...
			if (CheckUtil.IsEmpty(beans)) {
				...
				if (CheckUtil.IsEmpty(beans.get(0).getOpenProportion())) {
					...
					bundle5.putInt("OpenProportion", (int) (Float.valueOf(beans
							.get(0).getOpenProportion()) * 100));
				}
				if (CheckUtil.IsEmpty(beans.get(0).getOpenHigh())) {
		...
		case R.id.layout_relative_changes_one:
			...
			if (CheckUtil.IsEmpty(beans)) {
				...
				if (CheckUtil.IsEmpty(beans.get(0).getOpenProportion())) {
					...
					bundle6.putInt("OpenProportion", (int) (Float.valueOf(beans
							.get(0).getOpenProportion()) * 100));
				}
				if (CheckUtil.IsEmpty(beans.get(0).getOpenHigh())) {
		...
		case R.id.layout_relative_changes_two:
			...
			if (CheckUtil.IsEmpty(beans)) {
				...
				if (CheckUtil.IsEmpty(beans.get(0).getOpenProportion())) {
					...
					bundle7.putInt("OpenProportion", (int) (Float.valueOf(beans
							.get(0).getOpenProportion()) * 100));
				}
				if (CheckUtil.IsEmpty(beans.get(0).getOpenHigh())) {
		...
		case R.id.layout_relative_changes_three:
			...
			if (CheckUtil.IsEmpty(beans)) {
				...
				if (CheckUtil.IsEmpty(beans.get(0).getOpenProportion())) {
					...
					bundle8.putInt("OpenProportion", (int) (Float.valueOf(beans
							.get(0).getOpenProportion()) * 100));
				}
				if (CheckUtil.IsEmpty(beans.get(0).getOpenHigh())) {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		if (CheckUtil.IsEmpty(beans.get(position).getOpenProportion())) {
			...
			bundle.putInt("OpenProportion", (int) (Float.valueOf(beans.get(
					position).getOpenProportion()) * 100));
		}
	...
	private void Fetch() {
		if (!CheckUtil.IsEmpty(beens.get(0).getSuperEqu())) {
			...
			SharedUtils.setParam(getActivity(), "DisEquID", beens.get(0)
					.getSuperEqu());
			try {
				str1 = java.net.URLEncoder.encode(str1, "UTF-8");
			} catch (UnsupportedEncodingException e1) {
			...
			RequestParams param3 = new RequestParams(URL.findDisWaterInfoOne
					+ str1); // 网址(请替换成实际的网址)
			...
			x.http().request(HttpMethod.GET, param3,
					new CommonCallback<String>() {
						...
						public void onSuccess(String arg0) {
							...
							Gson gson = new Gson();
							System.out.println(arg0);
							FindDisWaterInfoOneBean fromJson = gson.fromJson(
									arg0, FindDisWaterInfoOneBean.class);
							// authorizedBeen = new AuthorizedBeen();
							// authorizedBeen = gson.fromJson(arg0,
							// AuthorizedBeen.class);
							beens = fromJson.getDisWaterInfo();
							beans = fromJson.getSluiceGateInfo();
							if (!CheckUtil.IsEmpty(beans)) {
								adapter.addData(beans, true);
								...
								if (beans.size() == 1) {
									layout.setVisibility(View.VISIBLE);
									layout_linear_change
											.setVisibility(View.GONE);
									layout_linear_changes
											.setVisibility(View.GONE);
									list_apply_water_distrbution_gate_control
											.setVisibility(View.GONE);
									RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) layout_relative_changes
											.getLayoutParams();
									int height;
									if (CheckUtil.IsEmpty(beans.get(0)
											.getOpenProportion())) {
										height = DensityUtil
												.dip2px(getActivity(),
														(int) ((100 - Float
									...
									if (CheckUtil.IsEmpty(beans.get(0)
										...
										tv_one_OpenHigh.setText(beans.get(0)
												.getOpenHigh() + "m³");
									}
									tv_one_PoreID.setText(beans.get(0)
											.getPoreID() + "");
								} else if (beans.size() == 2) {
									layout.setVisibility(View.GONE);
									layout_linear_change
									...
									if (CheckUtil.IsEmpty(beans.get(0)
										...
										tv_two_OpenHigh_left.setText(beans.get(
												0).getOpenHigh()
												+ "m³");
									}

									tv_two_PoreID_left.setText(beans.get(0)
											.getPoreID());

									RelativeLayout.LayoutParams layoutParam1 = (RelativeLayout.LayoutParams) layout_relative_changes_right
											.getLayoutParams();
									int heights;
									if (CheckUtil.IsEmpty(beans.get(1)
											.getOpenProportion())) {
										heights = DensityUtil
												.dip2px(getActivity(),
														(int) ((100 - Float
									...
									if (CheckUtil.IsEmpty(beans.get(1)
										...
										tv_two_OpenHigh_right.setText(beans
												.get(1).getOpenHigh() + "m³");
									}
									tv_two_PoreID_right.setText(beans.get(1)
											.getPoreID());
								} else if (beans.size() == 3) {
									layout.setVisibility(View.GONE);
									layout_linear_change
									...
									if (CheckUtil.IsEmpty(beans.get(0)
											.getOpenHigh())) {
										tv_three_OpenHigh_left
												.setText(0 + "m³");
									} else {
										tv_three_OpenHigh_left.setText(beans
												.get(0).getOpenHigh() + "m³");
									}
									tv_three_PoreID_left.setText(beans.get(0)
											.getPoreID());
									...
									tv_three_PoreID.setText(beans.get(1)
											.getPoreID());

									RelativeLayout.LayoutParams layoutParam2 = (RelativeLayout.LayoutParams) layout_relative_changes_three
											.getLayoutParams();
									int height2;
									if (CheckUtil.IsEmpty(beans.get(2)
											.getOpenProportion())) {
										height2 = DensityUtil
												.dip2px(getActivity(),
														(int) ((100 - Float
									...
									if (CheckUtil.IsEmpty(beans.get(2)
											.getOpenHigh())) {
										tv_three_OpenHigh_right
												.setText(0 + "m³");
									} else {
										tv_three_OpenHigh_right.setText(beans
												.get(2).getOpenHigh() + "m³");
									}
									tv_three_PoreID_right.setText(beans.get(2)
											.getPoreID());
								} else if (beans.size() > 3) {
									layout_show_left_and_right
											.setVisibility(View.VISIBLE);
							...
							if (!CheckUtil.IsEmpty(beens)) {
								if (CheckUtil.IsEmpty(beens.get(0)
										.getDisEquName())) {
									text_apply_water_distrbution_gate_control
											.setText("");
								} else {
									text_apply_water_distrbution_gate_control
											.setText(beens.get(0)
								...
								if (CheckUtil
										.IsEmpty(beens.get(0).getPoreNum())) {
									tv_indicator.setText("");
								} else {
									tv_indicator.setText(beens.get(0)
											.getPoreNum());
								}
								if (CheckUtil.IsEmpty(beens.get(0)
										.getFrontWaterLevel())) {
								...
								public void onClick(View widget) {
									if (NetStatusUtil.isNetValid(getActivity())) {
										...
										Toast.makeText(getActivity(),
												"当前网络不可用！请检查您的网络状态！", Toast.LENGTH_SHORT)
												.show();
									}
								}
							};
							style.setSpan(what, 6, beens.get(0).getSuperEqu()
									.length() + 6,
									Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
							tv_superior.setText(style);
							tv_superior.setMovementMethod(LinkMovementMethod
									.getInstance());
							progressDialog.dismiss();
						}
					});

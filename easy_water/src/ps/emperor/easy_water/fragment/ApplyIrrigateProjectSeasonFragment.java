...
public class ApplyIrrigateProjectSeasonFragment extends Fragment implements
	...
	private int id, setNight, setLong, round,isSkips;
				...
				x.http().request(HttpMethod.POST, param2,
						new CommonCallback<String>() {
							...
							public void onSuccess(String arg0) {
								...
								}else if("3".equals(fromJson.getCode())){
									Toast.makeText(getActivity(), "添加失败！该时间段已超出灌季范围，请重新选择时间段！", Toast.LENGTH_SHORT).show();
								}
							}
						});
			}

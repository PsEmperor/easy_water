 ...
 */
@SuppressLint("NewApi")
public class MainTainPresentIrrigateFragment extends Fragment implements
		OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(
				R.layout.fragment_maintain_present_irriagte, container, false);

		actionBar = (MainActionBar) view
				.findViewById(R.id.actionbar_maintain_present_irrigate);
		...
		listView = (GridView) view
				.findViewById(R.id.list_maintain_irrigat_info_group);
		group = (TextView) view
				.findViewById(R.id.text_maintain_irrigat_info_group);

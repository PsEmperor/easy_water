...
public class MinesFragment extends Fragment implements OnClickListener {
	...
	private TextView text_main_user_name,text_main_user_tel;
	private String user_name,user_tel;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		text_main_user_name = (TextView) view.findViewById(R.id.text_main_user_name);
		user_name = (String) SharedUtils.getParam(getActivity(), "user_name", "");
		text_main_user_name.setText(user_name);
		text_main_user_tel = (TextView) view.findViewById(R.id.text_main_user_tel);
		user_tel = (String) SharedUtils.getParam(getActivity(), "user_tel", "");
		text_main_user_tel.setText(user_tel);
		...
		}else if(bitmapFileFromDiskCache != null){

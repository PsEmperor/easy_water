...
public class ApplyIrrigateProjectSingleFragment extends Fragment implements
	...
	private String time_start, time_max_start, NightStart, NightEnd, units,
			nContinue;
	private int aYear, aMonth, aDay, aHours, aMinutes, isFront, MatchedNum;
	private IrrigationProject irrigationProject;
	private int isSkips, long_hour;
	private long temp, compare, compares;
	private int setLong, setNight;
	...
	public void onClick(View v) {
		...
		case R.id.toggle_apply_irriagte_project_single_time_night:
			break;
		case R.id.toggle_apply_irriagte_project_single_time_longs:
			break;
		default:
			break;
		}

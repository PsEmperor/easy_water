...
public class MainTainGateInfoFragment extends Fragment implements
	...
	private TextView gate_info_category, gate_info_id, gate_info_e,
			gate_info_n, gate_info_units, gate_info_superiro, gate_info_hole;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		gate_info_category = (TextView) view
				.findViewById(R.id.text_maintain_gate_info_category);
		gate_info_id = (TextView) view
				.findViewById(R.id.text_maintain_gate_info_id);
		gate_info_e = (TextView) view
				.findViewById(R.id.text_maintain_gate_info_e);
		gate_info_n = (TextView) view
				.findViewById(R.id.text_maintain_gate_info_n);
		gate_info_name = (EditText) view
				.findViewById(R.id.text_maintain_gate_info_name);
		gate_info_units = (TextView) view
				.findViewById(R.id.text_maintain_gate_info_units);
		gate_info_superiro = (TextView) view
				.findViewById(R.id.text_maintain_gate_info_superiro);
		gate_info_area = (EditText) view
				.findViewById(R.id.text_maintain_gate_info_area);
		gate_info_hole = (TextView) view
				.findViewById(R.id.text_maintain_gate_info_hole);
	...
	private void init() {
		...
		x.http().request(HttpMethod.GET, param3, new CommonCallback<String>() {
			...
			public void onSuccess(String arg0) {
				...
				FindDisEquInfoOneBean fromJson = gson.fromJson(arg0,
						FindDisEquInfoOneBean.class);
		...
		case R.id.acitionbar_right:
			if (!NetStatusUtil.isNetValid(getActivity())) {
				...
				try {
					...
					js_request.put("disEquName", gate_info_name.getText()
							.toString().trim());

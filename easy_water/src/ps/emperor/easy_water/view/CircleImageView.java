	...
	private Bitmap getBitmapFromDrawable(Drawable drawable) {
		...
		try {
			...
			if (drawable instanceof ColorDrawable) {
				...
				if ((CheckUtil.IsEmpty(drawable.getIntrinsicWidth()) || drawable
						.getIntrinsicWidth() <= 0)
						&& CheckUtil.IsEmpty(drawable.getIntrinsicHeight())
						|| drawable.getIntrinsicHeight() <= 0) {
					bitmap = Bitmap.createBitmap(50, 50, BITMAP_CONFIG);
				} else if (CheckUtil.IsEmpty(drawable.getIntrinsicWidth())
						|| drawable.getIntrinsicWidth() <= 0) {
					bitmap = Bitmap.createBitmap(50,
							drawable.getIntrinsicHeight(), BITMAP_CONFIG);
				} else if (CheckUtil.IsEmpty(drawable.getIntrinsicHeight())
						|| drawable.getIntrinsicHeight() <= 0) {

...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        IrrigationDao.createTable(db, ifNotExists);
        WaterDao.createTable(db, ifNotExists);
        IrrigationProjectDao.createTable(db, ifNotExists);
        IrrigationGroupDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        IrrigationDao.dropTable(db, ifExists);
        WaterDao.dropTable(db, ifExists);
        IrrigationProjectDao.dropTable(db, ifExists);
        IrrigationGroupDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(IrrigationDao.class);
        registerDaoClass(WaterDao.class);
        registerDaoClass(IrrigationProjectDao.class);
        registerDaoClass(IrrigationGroupDao.class);

...
/** 
 * DAO for table SINGLE_VALUE.
*/
public class SingleValueDao extends AbstractDao<SingleValue, Long> {

    public static final String TABLENAME = "SINGLE_VALUE";

    /**
     * Properties of entity SingleValue.<br/>
    ...
    */
    ...
    public SingleValueDao(DaoConfig config) {
        super(config);
    }
    
    public SingleValueDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'SINGLE_VALUE'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, SingleValue entity) {
        stmt.clearBindings();
        ...
        if (valuestate != null) {
            stmt.bindString(4, valuestate);
        }
 
        String durationtime = entity.getDurationtime();
        if (durationtime != null) {
            stmt.bindString(5, durationtime);
        }
    }
    ...
    /** @inheritdoc */
    @Override
    public SingleValue readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(SingleValue entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(SingleValue entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;

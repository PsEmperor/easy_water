...
public class DBHelper {
	...
	public static DBHelper getInstance(Context context) {
		if (instance == null) {
			...
			instance.irrigationprojectDao = instance.mDaoSession
					.getIrrigationProjectDao();
			instance.irrigationGroupDao = instance.mDaoSession
					.getIrrigationGroupDao();
			instance.valueDao = instance.mDaoSession.getSingleValueDao();
			instance.irrigationIsFirstDao = instance.mDaoSession
					.getIrrigationIsFirstDao();
		}
		return instance;
	}
	...
	public List<IrrigationProject> loadLastMsgBySessionid(String irrigation) {
		QueryBuilder<IrrigationProject> mqBuilder = irrigationprojectDao
				.queryBuilder();
		mqBuilder
				.where(ps.emperor.easy_water.greendao.IrrigationProjectDao.Properties.Irrigation
						.eq(irrigation))
				.orderDesc(
						ps.emperor.easy_water.greendao.IrrigationProjectDao.Properties.Irrigation);
	...
	// //根据灌溉单元查询计划 倒序
	// public List<IrrigationProject> loadLastMsgBySessionidOnle(String
	// irrigation){
	// QueryBuilder<IrrigationProject> mqBuilder =
	// irrigationprojectDao.queryBuilder();
	...
	// 根据灌溉单元查询十轮计划 正序
	public List<IrrigationProject> loadLastMsgBySessionidTen(String irrigation,
			int limit) {
		QueryBuilder<IrrigationProject> mqBuilder = irrigationprojectDao
				.queryBuilder();
		mqBuilder
	...
	// 根据灌溉单元分段查询计划
	public List<IrrigationProject> loadProjectByOne(String irrigation,
			int MatchedNum, int limit) {
		QueryBuilder<IrrigationProject> mqBuilder = irrigationprojectDao
				.queryBuilder();
		mqBuilder
				.where(ps.emperor.easy_water.greendao.IrrigationProjectDao.Properties.Irrigation
						.eq(irrigation)).offset(MatchedNum);
		mqBuilder
				.limit(limit)
				.orderDesc(
						ps.emperor.easy_water.greendao.IrrigationProjectDao.Properties.Irrigation);
	...
	public List<IrrigationGroup> loadGroupByUnits(String irrigation) {
		QueryBuilder<IrrigationGroup> mqBuilder = irrigationGroupDao
				.queryBuilder();
		mqBuilder
				.where(IrrigationGroupDao.Properties.Irrigation.eq(irrigation))
	...
	public List<IrrigationIsFirst> loadisFirst(String irrigation) {
		QueryBuilder<IrrigationIsFirst> mqBuilder = irrigationIsFirstDao
				.queryBuilder();
		mqBuilder.where(
				IrrigationIsFirstDao.Properties.Irrigation.eq(irrigation))
	...
	public List<Irrigation> loadContinue(String irrigation) {
		...
		mqBuilder.where(Properties.Irrigation.eq(irrigation)).orderDesc(
	 ...
	 */
	// 根据灌溉单元查询-id删除 正序
	public List<IrrigationProject> loadLastMsgByDelete(String irrigation,
			int round) {
		QueryBuilder<IrrigationProject> mqBuilder = irrigationprojectDao
				.queryBuilder();
		mqBuilder
				.where(ps.emperor.easy_water.greendao.IrrigationProjectDao.Properties.Irrigation
						.eq(irrigation))
				.where(ps.emperor.easy_water.greendao.IrrigationProjectDao.Properties.Round
						.eq(round))
				.orderDesc(
						ps.emperor.easy_water.greendao.IrrigationProjectDao.Properties.Irrigation);
		List<IrrigationProject> irrigations = new ArrayList<IrrigationProject>();
	...
	// 更新基本信息
	public void updateBasic(String id, int valuenumber, int groupnumber,
			String flushtime, int isTimeLong, String NightStart, String NightEnd) {
		Irrigation findUser = irrigationDao.queryBuilder()
				.where(Properties.Irrigation.eq(id)).build().unique();
		if (findUser != null) {
			...
			findUser.setFlushtime(flushtime);
			findUser.setNightStart(NightStart);
			findUser.setNightEnd(NightEnd);
			irrigationDao.update(findUser);
		}
	}
	...
	// 更新设备ID
	public void updateBasicFirstDerviceID(String id, String FirstDerviceID) {
		Irrigation findUser = irrigationDao.queryBuilder()
				.where(Properties.Irrigation.eq(id)).build().unique();
		if (findUser != null) {
			findUser.setFirstDerviceID(FirstDerviceID);
			irrigationDao.update(findUser);
		}
	}

	// 更新经纬度
	public void updateBasicLongitude(String id, String Longitude,
			String Latitude) {
		Irrigation findUser = irrigationDao.queryBuilder()
				.where(Properties.Irrigation.eq(id)).build().unique();
		if (findUser != null) {
			findUser.setLongitude(Longitude);
			findUser.setLatitude(Latitude);
			irrigationDao.update(findUser);
		}
	}

	// 更新面积
	public void updateBasicArea(String id, String Area) {
		Irrigation findUser = irrigationDao.queryBuilder()
				.where(Properties.Irrigation.eq(id)).build().unique();
		if (findUser != null) {
	...
	// 更新上级设备
	public void updateBasicSuperEqu(String id, String SuperEqu) {
		Irrigation findUser = irrigationDao.queryBuilder()
				.where(Properties.Irrigation.eq(id)).build().unique();
		if (findUser != null) {
			findUser.setSuperEqu(SuperEqu);
			irrigationDao.update(findUser);
		}
	}
	...
	// 更新夜间休息时间
	public void updateBasicTime(String id, String NightStart, String NightEnd) {
		Irrigation findUser = irrigationDao.queryBuilder()
				.where(Properties.Irrigation.eq(id)).build().unique();
		if (findUser != null) {
			findUser.setNightStart(NightStart);
	...
	// 更新灌季
	public void updateBasicSeason(String id, String seasonStart,
			String seasonEnd) {
		Irrigation findUser = irrigationDao.queryBuilder()
				.where(Properties.Irrigation.eq(id)).build().unique();
		if (findUser != null) {
	...
	public void updateProject(String id, int randomCommon, String start,
			String end) {
		IrrigationProject findUser = irrigationprojectDao
				.queryBuilder()
				.where(ps.emperor.easy_water.greendao.IrrigationProjectDao.Properties.Round
						.eq(id))
				.where(IrrigationProjectDao.Properties.Marshalling
						.eq(randomCommon)).build().unique();
		if (findUser != null) {
	...
	public void updateRound(String irrigation, String id, String round) {
		IrrigationProject findUser = irrigationprojectDao
				...
				.where(ps.emperor.easy_water.greendao.IrrigationProjectDao.Properties.Irrigation
						.eq(irrigation))
				.where(IrrigationProjectDao.Properties.Id.eq(id)).build()
				.unique();
		if (findUser != null) {
	...
	public void updateProjects(String irrigation, String id, int randomCommon,
	...
	public List<Irrigation> loadMoreMsgById(String irrigation, Long id) {
		QueryBuilder<Irrigation> mqBuilder = irrigationDao.queryBuilder();
		mqBuilder
				.where(IrrigationProjectDao.Properties.Round.lt(id))
				.where(IrrigationProjectDao.Properties.Irrigation
						.eq(irrigation))
				.orderDesc(IrrigationProjectDao.Properties.Id).limit(20);

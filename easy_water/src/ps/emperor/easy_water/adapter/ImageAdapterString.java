...
import ps.emperor.easy_water.entity.GateBean;
...
public class ImageAdapterString extends BaseAdapter{    
    private Context mContext;			// 定义Context
    private Vector<GateBean> mImageIds;	// 定义一个向量作为图片源
    ...
    public ImageAdapterString(Context c, boolean isMulti,Vector<GateBean>  mImageId){
    	mContext = c;
    	multiChoose = isMulti;
    	mImageIds = mImageId;

...
public class ImageAdapterCrop extends BaseAdapter{    
    ...
    public ImageAdapterCrop(Context c, boolean isMulti,List<infoList>  mImageId){
    	mContext = c;
    	multiChoose = isMulti;
    	mImageIds = mImageId;
...
//        		mImage_bs.elementAt(position)));
        ...
        viewHolder.textView1.setText(mImageIds.get(position).getCropName());
